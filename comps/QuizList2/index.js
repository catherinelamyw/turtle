        ...
        <AnswerModalCont>
            <div className="cBox">
                ...
                <div className="cText">
                    ...
                    <WhiteTextUI parwidth="250" text={correct ? "The short distance from where they hatch to the sea is usually the most dangerous" : "Try again or skip this quiz"} fontsize="20" fontcolor="#242C3C"></WhiteTextUI><br/><br/>
                    <div className="row">
                        {
                            correct ?
                                <SmallButtonUI text="Home" routeTo="/qlist"></SmallButtonUI>
                                 :
                                (
                                    <>
                                        <SmallButtonUI text="Try Again" routeTo="/q2list"></SmallButtonUI>
                                        <SmallButtonUI text="Pass" routeTo="/qlist"></SmallButtonUI>
                                    </>
                                )
                        }
                    </div>
