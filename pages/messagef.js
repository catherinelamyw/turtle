...
export default function redintro(){
    ...
    return <RedCont>
            ...
            <div className="wrong">
              <WrongtUI height="675" width="338" routea="" routeb="/yellow3L" text2="Dispose chemicals in the sink" text4="Chemicals will harm marine life if the sewer drains reach the ocean. Contact your local recycling depot for proper disposal instructions."></WrongtUI>
            </div>
