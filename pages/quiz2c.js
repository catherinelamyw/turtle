...
export default function Quiz1() {
    return <Quiz1Cont>
        ...
        <div className="Mid">
            ...
            <ButtonUI text="Getting lost" bgcolor="#FFE9A7" onClick={()=>router.push("/quiz1b")}></ButtonUI>
            <ButtonUI text="As soon as they hatch" bgcolor="#F0F0F0" onClick={()=>router.push("/quiz1c")}></ButtonUI>
        </div>
        <div className="Bot">
