...
import CorrectUI from '../comps/Correct'
...
export default function redintro(){
    ...
    return <RedCont>
            ...
            <div className="correct">
              <CorrectUI height="675" width="338" routea="" text2="Wash your clothes with phosphate-free detergents" text4="Look out for biodegradable products and avoid phosphates, chlorine, and artificial fragrances."></CorrectUI>
            </div>
